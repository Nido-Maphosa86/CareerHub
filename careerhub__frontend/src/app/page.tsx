...
const jobs: JobListing[] = [
  ...
  },
  {
    ...
    salaryMin: 20000,
    salaryMax: 30000,
    // Posted more than 30 days ago — the relative date shows "X months ago"
...
export default function Home() {
  ...
  // Toggle handler — clicking an already-selected card deselects it.
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-6xl mx-auto px-8 py-8">
        ...
        {/* ── Summary panel ─────────────────────────────────────────────────
            Only exists in the DOM when a job is selected.
            When selectedJob is null this entire block is not rendered —
            not hidden with CSS, not an empty div — it does not exist.
            Conditional rendering with && produces a boolean false when
            selectedJob is null, and React renders nothing for false. */}
        {selectedJob !== null && (
